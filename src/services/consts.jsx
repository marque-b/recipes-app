...
export const INGREDIENT_RADIO = 'ingredient-search-radio';
export const NAME_RADIO = 'name-search-radio';
export const FIRST_LETTER_RADIO = 'first-letter-search-radio';
export const CARD_NAME = '0-card-name';
